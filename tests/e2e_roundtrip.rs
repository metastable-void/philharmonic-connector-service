...
const WAVE_A_SEED_HEX: &str = include_str!("../../docs/crypto-vectors/wave-a/wave_a_seed.hex");
const WAVE_A_PUBLIC_HEX: &str = include_str!("../../docs/crypto-vectors/wave-a/wave_a_public.hex");
...
const WAVE_A_COMPOSITION_PAYLOAD_HASH_HEX: &str =
    include_str!("../../docs/crypto-vectors/wave-a/wave_a_composition_payload_hash.hex");
const WAVE_A_COMPOSITION_COSE_SIGN1_HEX: &str =
    include_str!("../../docs/crypto-vectors/wave-a/wave_a_composition_cose_sign1.hex");
